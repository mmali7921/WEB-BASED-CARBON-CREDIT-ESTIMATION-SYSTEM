    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-1 flex flex-col items-center justify-center px-6 pt-20 pb-20 text-center">
                ...
                <div className="bg-secondary/20 hover:bg-secondary/30 transition-colors border border-border/50 p-12 w-full max-w-md animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300">
                    <form action={handleSignIn}>
                        <Button
                            type="submit"
                            size="lg"
                            variant="outline"
                            className="w-full rounded-none px-8 py-7 bg-background text-foreground hover:bg-secondary/50 border-border transition-all font-semibold uppercase tracking-widest text-xs flex items-center justify-center gap-4 shadow-sm"
                        >
                            {/* Google SVG Icon */}
